...
const samples = [
  ...
  ['monolith-angular-oauth2-mongodb-jdl', { 'legacy-sample-file': 'monolith-angular-auth-mongodb-template-jdl' }],
  'monolith-angular-oauth2-i18n-jdl',
  'monolith-angular-jwt-i18n-dev',
  ['monolith-angular-jwt-mongodb-jdl', { 'legacy-sample-file': 'monolith-client-auth-database-template-jdl' }],
