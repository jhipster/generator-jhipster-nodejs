            ...
            templates: [
                {
                    ...
                    renameTo: generator => `src/domain/${generator.asEntity(generator.entityClass)}.ts`
                }
                // ,
                // {
                //     file: 'repository/EntityRepository.ts',
                //     renameTo: generator => `${generator.packageFolder}/repository/${generator.entityClass}Repository.ts`
                // },
                // {
                //     file: 'web/rest/EntityResource.ts',
                //     renameTo: generator => `${generator.packageFolder}/web/rest/${generator.entityClass}Resource.ts`
                // }
            ]
        }
        // ,
