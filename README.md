...
This project adds nodejs for your backend, **all typescript files generation, not JAVA REQUIRED!**, to the [JHipster](https://www.jhipster.tech/) application 😎. It is based on JHipster Blueprint 🔵, that is meant to be used in a JHipster application.
